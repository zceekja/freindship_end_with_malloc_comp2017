...
int main() {
    ...
    void* data2 =virtual_malloc(virtual_heap,1500);
    void* data3 =virtual_malloc(virtual_heap,1500);
    void* data4 =virtual_malloc(virtual_heap,1500);
    virtual_free(virtual_heap,data2);
    virtual_realloc(virtual_heap,data4,1500);
